...
ENTSOEapi.prototype.getData = function (options, callback) {
  ...
  reqStr = "https://web-api.tp.entsoe.eu/api?securityToken=" + this.webkey;
...
ENTSOEapi.query.prototype.PlannedUnavailabilityOfConsumptionUnits =
  function () {
    var options = {
      documentType: "A76",
      businessType: "A53",
...
ENTSOEapi.query.prototype.PlannedUnavailabilityOfTransmissionUnits =
  function () {
    var options = {
      documentType: "A78",
      businessType: "A53",
...
ENTSOEapi.query.prototype.ForcedUnavailabilityOfTransmissionUnits =
  function () {
    var options = {
      documentType: "A78",
      businessType: "A54",
